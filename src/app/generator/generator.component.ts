...
export class GeneratorComponent implements OnInit {
  ...
  randomFood(offset: number) {
    return this.foods[Math.max(this.currentDay + offset, 0) % this.foods.length];
  }
